# Created on : 25-Oct-2023, 1:40:08 am
# Author     : Mukesh Shah
#=========================IMPORTING MODULES========================================
import tkinter
...
txt.insert('6.0','Python APP Project \n')
txt.insert('7.0','Btech CSE Core \n')
txt.insert('8.0','M1 Section \n')
txt.insert('9.0','Made by:  Mukesh Kumar Shah (RA2211003010234)\n ')
...
load= Image.open(r"C:\Users\Mukesh Shah\Desktop\0408fecb-4d79-4a74-b7fd-b61c6aafef7a.jpeg")
