# Created on : 25-Oct-2023, 1:48:54 am
# Author     : Mukesh Shah
#=========================IMPORTING MODULES========================================
...
def insert():
    ...
    if (docid=="" or dname == "" or dmob == "" or ddob == "" or ddpt == "" or dem == "") :
        ...
        con = mysql.connect(host = "localhost" , user = "root" , password = "Mukesh#123" , database="clinic")
        if con.is_connected():
            print("Success")
        cursor = con.cursor()
        query = "insert into doctors(D_ID , D_NAME , D_MOBILE, D_LANDLINE , D_DOB , D_SPECIAL , D_ADDRESS , D_DEPT , D_EMAIL , D_DEGREES) " \
                "values({} , '{}' , '{}' , '{}' , '{}' , '{}' , '{}' , '{}' , '{}' , '{}')"\
